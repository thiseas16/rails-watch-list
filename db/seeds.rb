...
my_list = List.create(name: 'Emotional')

bookmark = Bookmark.new(comment: 'excellent movie', movie: titanic, list: my_list)
bookmark.save


puts "Added #{Movie.count} movies!"
puts "Added #{Bookmark.count} bookmarks!"
puts "Added #{List.count} lists!"
